export const CONTAINER = 'text-brown-1 p-4 flex justify-between flex-col w-full md:flex-row'

export const IMG_CONTAINER = 'w-full flex justify-center items-center'

export const DESCRIPTION_CONTAINER = ' w-auto md:w-1/2  space-y-6 flex flex-col justify-around'
...
export const BUTTON = 'bg-brown-3 text-white rounded px-4 w-52 py-2'
...
export const RELATED_MOVIES = 'flex space-x-3 w-full p-2 pb-0 overflow-x-auto scrollbar-hide'

export const RELATED_MOVIE = 'w-[92px] min-w-[92px] flex flex-col  justify-center cursor-pointer '
