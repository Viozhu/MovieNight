      ...
      <div className="flex flex-col md:flex-row justify-center items-center w-full">
        <ul className="px-4 w-full lg:w-1/4   pb-6 pt-6 lg:pt-3">
          ...
          <p className="text-gray-100 text-sm">
            Front-end lover looking for opportunities to seize new trends. I’m
            able to work under pressure, taking advantage of all resources
            available or looking for new ones in order to creatively solve
            potential issues. I’m comfortable with deadlines and team work. In
            my experience, I’ve managed to gather information so as to compare
            and improve apps employing several tools
          </p>
